...
class TLDetector(object):
    ...
    def pose_cb(self, msg):
        self.pose = msg
        #rospy.loginfo("TLDetector pose_cb: %lf, %lf, %lf", self.pose.pose.position.x, self.pose.pose.position.y, self.pose.pose.position.z)
    ...
    def waypoints_cb(self, msg):
        ...
        #if len(self.base_lane.waypoints) > 0:
        #    rospy.loginfo("TLDetector waypoints_cb: %lf, %lf, %lf", msg.waypoints[0].pose.pose.position.x, msg.waypoints[0].pose.pose.position.y, msg.waypoints[0].pose.pose.position.z)
        #else:
        #    rospy.loginfo("TLDetector waypoints_cb: None")

    def traffic_cb(self, msg):
        self.lights = msg.lights
        #if len(self.lights) > 0:
        #    rospy.loginfo("TLDetector traffic_cb: %lf", self.lights[0].state)
        #else:
        #    rospy.loginfo("TLDetector traffic_cb: None")
    ...
    def get_light_state(self, light):
        ...
        rospy.loginfo("TrafficLight gt / result: %d / %d", light.state, state_cl)
